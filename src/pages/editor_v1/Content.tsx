    ...
    <>
      <div className="flex flex-1 flex-col">
        <div className="grid grid-cols-2 gap-4 h-full">
          ...
          <div className="h-full" onContextMenu={handleContextMenu}>
            <TextEditor placeholder={placeholder} className="h-full" content={testContent} />
          </div>
        </div>
      </div>
      ...
      {contextBubble && (
        ...
        >
          <ContextBubble variant="floating">
            ...
            />
            <ContextBubbleGroup>
              <ContextBubbleButton tooltip="Add Link" onClick={() => {}}>
                <LinkIcon className="h-4 w-4" />
              </ContextBubbleButton>

              <ContextBubbleButton tooltip="Remove Link" onClick={() => {}}>
            ...
            />
            <ContextBubbleGroup>
              <ContextBubbleButton tooltip="Bullet List" onClick={() => {}}>
                <List className="h-4 w-4" />
              </ContextBubbleButton>

              <ContextBubbleButton tooltip="Numbered List" onClick={() => {}}>
                <ListOrdered className="h-4 w-4" />
              </ContextBubbleButton>

              <ContextBubbleButton tooltip="Quote" onClick={() => {}}>
            ...
            />
            <ContextBubbleGroup>
              <ContextBubbleButton tooltip="Heading 1" onClick={() => {}}>
                <Heading1 className="h-4 w-4" />
              </ContextBubbleButton>

              <ContextBubbleButton tooltip="Heading 2" onClick={() => {}}>
                <Heading2 className="h-4 w-4" />
              </ContextBubbleButton>

              <ContextBubbleButton tooltip="Heading 3" onClick={() => {}}>
                <Heading3 className="h-4 w-4" />
              </ContextBubbleButton>

              <ContextBubbleButton tooltip="Paragraph" onClick={() => {}}>
...
function ContextBubbleSubmenus({
  ...
  React.useLayoutEffect(() => {
    if (showSubmenu === 'colors' && colorsTriggerRef.current && colorsSubmenuRef.current) {
      ...
      highlightTriggerRef.current &&
      highlightSubmenuRef.current
    ) {
  ...
  return (
    <>
      {showSubmenu === 'colors' && (
        <ContextBubbleSubmenu ref={colorsSubmenuRef} style={submenuStyles.colors}>
      ...
      {showSubmenu === 'highlight' && (
        <ContextBubbleSubmenu ref={highlightSubmenuRef} style={submenuStyles.highlight}>
          <div className="grid grid-cols-4 gap-1.5">
      ...
      {showSubmenu === 'align' && (
        <ContextBubbleSubmenu ref={alignSubmenuRef} style={submenuStyles.align}>
          <div className="space-y-1">
            <button
      ...
      {showSubmenu === 'lists' && (
        <ContextBubbleSubmenu ref={listsSubmenuRef} style={submenuStyles.lists}>
          <div className="space-y-1">
            <button
              className="w-full flex items-center px-2 py-1.5 text-sm hover:bg-accent rounded-sm transition-colors"
              onClick={() => {
