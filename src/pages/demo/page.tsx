...
import IconAddPeople from '@/components/app/icons/IconAddPeople'
import IconOuterMarginNote from '@/components/app/icons/IconOuterMarginNote'

const Account = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
  return (
    <svg
      width="24"
      height="24"
...
const TextEdit = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
  return (
    <svg
      width="24"
      height="24"
      ...
      ref={ref}
    >
      <g id="Icons / General / Tabs">
        <path
          id="Shape"
          d="M4.30775 18H19.6923C19.7693 18 19.8398 17.9679 19.9038 17.9038C19.9679 17.8398 20 17.7692 20 17.6923V10H13V6H4.30775C4.23075 6 4.16025 6.03208 4.09625 6.09625C4.03208 6.16025 4 6.23075 4 6.30775V17.6923C4 17.7692 4.03208 17.8398 4.09625 17.9038C4.16025 17.9679 4.23075 18 4.30775 18ZM4.30775 19.5C3.80258 19.5 3.375 19.325 3.025 18.975C2.675 18.625 2.5 18.1974 2.5 17.6923V6.30775C2.5 5.80258 2.675 5.375 3.025 5.025C3.375 4.675 3.80258 4.5 4.30775 4.5H19.6923C20.1974 4.5 20.625 4.675 20.975 5.025C21.325 5.375 21.5 5.80258 21.5 6.30775V17.6923C21.5 18.1974 21.325 18.625 20.975 18.975C20.625 19.325 20.1974 19.5 19.6923 19.5H4.30775Z"
        />
      </g>
    </svg>
  )
    ...
    <div className="p-8 space-y-12">
      ...
      <section>
        <AppButton
          variant="outline"
          size="xl"
          className="transition-all duration-200 text-red-500 dark:text-amber-300"
        >
          <Account />
          <span>The color</span>
        </AppButton>
        ...
        <AppButton size="xl">
          <Account /> Large Button
        </AppButton>
        <AppButton size="2xl">
          <Account /> Extra Large Button
        </AppButton>

        <AppButton size="sm">
          <TextEdit /> Small Button
        </AppButton>
        <AppButton size="xl">
          <TextEdit /> Large Button
        </AppButton>
        <AppButton size="2xl">
          <TextEdit /> Extra Large Button
        </AppButton>

        <AppButton size="sm">
          <IconAddPeople /> Small Button
        </AppButton>
        <AppButton size="xl">
          <IconAddPeople /> Large Button
        </AppButton>
        <AppButton size="2xl">
          <IconAddPeople /> Extra Large Button
        </AppButton>
        <AppButton size="icon">
          <IconOuterMarginNote />
        </AppButton>
        ...
        <div className="flex flex-wrap items-center gap-4">
          {roundedOptions.map((rounded) => (
            <div key={rounded} className="space-y-2">
              ...
              <AppButton rounded={rounded}>{rounded}</AppButton>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="flex flex-wrap items-center gap-4">
          {shadowOptions.map((shadow) => (
            <div key={shadow} className="space-y-2">
              ...
              <AppButton shadow={shadow}>{shadow}</AppButton>
            </div>
          ))}
        </div>
      </section>
