  ...
  return (
    <div className="value">
      ...
      <input
        value={value}
        readOnly
        style={{ backgroundColor: '#eee', cursor: 'auto', border: 0 }}
      />
    </div>
  )
}
...
function SelfDrivenDisplay({ fieldName = '', label }: Readonly<PropDrivenDisplayProps>) {
  ...
  return (
    <div className="value">
      {label ? <label>{label} : </label> : null}
      <input
        value={value[fieldName].get as string}
        readOnly
        style={{ backgroundColor: '#eee', cursor: 'auto', border: 0 }}
      />
    </div>
...
function PropDrivenFormContainer() {
  ...
  return (
    <div className="container">
      ...
      <FormDrivenTextInput
        value={fields.first.get as string}
        label="First Name"
        onChange={fields.first.set}
      />
      <FormDrivenTextInput
        value={fields.last.get as string}
        label="Last Name"
        onChange={fields.last.set}
      />
    </div>
  )
}
...
function FormDrivenTextInput({ label = '', value, onChange }: Readonly<Props>) {
  ...
  return (
    <AppFastContextProvider>
      <div className="container">
        ...
        <p>
          Switch on the re-render highlight function (see image) in dev tools to see when re-renders
          happen.
        </p>
        <MainPage />
      </div>
