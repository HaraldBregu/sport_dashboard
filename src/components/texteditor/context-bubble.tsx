...
function ContextBubbleGroup({ className, children, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
...
const ContextBubbleSubmenu = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(
